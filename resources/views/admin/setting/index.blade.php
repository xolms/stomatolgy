...
@section('content')
    <a href="{{route('setting.create')}}" class="btn btn-lg btn-success  btn-lg">Добавить новую</a>
    @if(isset($setting))
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">
											@if($item->type == 'text')
												{{$item->value}}
											@else
												<img src="{{$item->value}}" alt="{{$item->name_rus}}" style="max-width: 200px; width: 100%; height: auto;">
											@endif
										</td>
